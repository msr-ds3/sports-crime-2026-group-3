...
assaults_model <- lm(assault ~ home_game + away_game + day_of_the_week + month + year + factor(ori, ordered = FALSE), data = regression_df )
summary(assaults_model)
vandalism_model <- lm(vandalism ~ home_game + away_game + day_of_the_week + month + year + factor(ori,ordered = FALSE), data = regression_df)
